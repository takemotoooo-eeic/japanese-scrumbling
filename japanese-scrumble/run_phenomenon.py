...
arg_parser.add_argument(
    ...
    dest="models",
    required=True,
    help="Model names, comma separated, e.g.: `gpt2, grnn`",
)
...
arg_parser.add_argument(
    ...
    dest="names_size",
    required=True,
    help="Names size: 'tiny', 'small', 'large'",
)
arg_parser.add_argument(
    "-g",
    "--grammar",
    ...
    default=None,
    type=str,
    help="Run specific grammar, zero-indexed, comma-separated. Default: run all grammars in phenomenon.",
)
